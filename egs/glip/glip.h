...
extern "C" {
  ...
  int glip_send(glip_context_t *, const size_t data_len, const char *data);
  int glip_recv(glip_context_t *, size_t* data_len, char **data);
...
#endif
#define glCreateShader glip_glCreateShader

GLAPI void glip_glShaderSource(GLuint shader, GLsizei count, const GLchar* const *string, const GLint *length);
#ifdef glShaderSource
#undef glShaderSource
#endif
#define glShaderSource glip_glShaderSource

GLAPI void glip_glCompileShader(GLuint shader);
#ifdef glCompileShader
#undef glCompileShader
#endif
#define glCompileShader glip_glCompileShader

GLAPI void glip_glGetShaderiv(GLuint shader, GLenum pname, GLint *params);
#ifdef glGetShaderiv
#undef glGetShaderiv
#endif
#define glGetShaderiv glip_glGetShaderiv
...
#endif
#define glGetProgramInfoLog glip_glGetProgramInfoLog

GLAPI void glip_glDeleteProgram(GLuint program);
#ifdef glDeleteProgram
#undef glDeleteProgram
#endif
#define glDeleteProgram glip_glDeleteProgram

GLAPI void glip_glUseProgram(GLuint program);
#ifdef glUseProgram
#undef glUseProgram
#endif
#define glUseProgram glip_glUseProgram

GLAPI void glip_glGetIntegerv(GLenum  pname, GLint *params);
#ifdef glGetIntegerv
#undef glGetIntegerv
#endif
#define glGetIntegerv glip_glGetIntegerv

GLAPI void glip_glGenFramebuffers(GLsizei n, GLuint *ids);
#ifdef glGenFramebuffers
#undef glGenFramebuffers
#endif
#define glGenFramebuffers glip_glGenFramebuffers

GLAPI void glip_glBindFramebuffer(GLenum target, GLuint framebuffer);
#ifdef glBindFramebuffer
#undef glBindFramebuffer
#endif
#define glBindFramebuffer glip_glBindFramebuffer

GLAPI void glip_glGenTextures(GLsizei n, GLuint * textures);
#ifdef glGenTextures
#undef glGenTextures
#endif
#define glGenTextures glip_glGenTextures

GLAPI void glip_glTexImage2D(GLenum target, GLint level, GLint internalFormat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid * data);
#ifdef glTexImage2D
#undef glTexImage2D
#endif
#define glTexImage2D glip_glTexImage2D

GLAPI void glip_glTexParameteri(GLenum target, GLenum pname, GLint param);
#ifdef glTexParameteri
#undef glTexParameteri
#endif
#define glTexParameteri glip_glTexParameteri
...
#endif
#define glFramebufferTexture glip_glFramebufferTexture

GLAPI void glip_glBindTexture(GLenum target, GLuint texture);
#ifdef glBindTexture
#undef glBindTexture
#endif
#define glBindTexture glip_glBindTexture

GLAPI void glip_glDrawBuffers(GLsizei n, const GLenum *bufs);
#ifdef glDrawBuffers
#undef glDrawBuffers
#endif
#define glDrawBuffers glip_glDrawBuffers

GLAPI void glip_glGenBuffers(GLsizei n, GLuint * buffers);
#ifdef glGenBuffers
#undef glGenBuffers
#endif
#define glGenBuffers glip_glGenBuffers

GLAPI void glip_glBindBuffer(GLenum target, GLuint buffer);
#ifdef glBindBuffer
#undef glBindBuffer
#endif
#define glBindBuffer glip_glBindBuffer

GLAPI void glip_glBufferData(GLenum target, GLsizeiptr size, const GLvoid * data, GLenum usage);
#ifdef glBufferData
#undef glBufferData
#endif
#define glBufferData glip_glBufferData

GLAPI void glip_glGenVertexArrays(GLsizei n, GLuint *arrays);
#ifdef glGenVertexArrays
#undef glGenVertexArrays
#endif
#define glGenVertexArrays glip_glGenVertexArrays

GLAPI void glip_glBindVertexArray(GLuint array);
#ifdef glBindVertexArray
#undef glBindVertexArray
#endif
#define glBindVertexArray glip_glBindVertexArray
...
#endif
#define glRenderbufferStorage glip_glRenderbufferStorage
...
#endif
#define glFramebufferRenderbuffer glip_glFramebufferRenderbuffer

GLAPI void glip_glVertexAttribDivisor(GLuint index, GLuint divisor);
#ifdef glVertexAttribDivisor
#undef glVertexAttribDivisor
#endif
#define glVertexAttribDivisor glip_glVertexAttribDivisor
...
#endif
#define glDrawElementsInstanced glip_glDrawElementsInstanced
...
#endif
#define glUniformMatrix2fv glip_glUniformMatrix2fv
...
#endif
#define glUniformMatrix3fv glip_glUniformMatrix3fv
...
#endif
#define glTexParameterf glip_glTexParameterf

GLAPI void glip_glGenerateMipmap(GLenum target);
#ifdef glGenerateMipmap
#undef glGenerateMipmap
#endif
#define glGenerateMipmap glip_glGenerateMipmap

GLAPI void glip_glDeleteBuffers(GLsizei n, const GLuint * buffers);
#ifdef glDeleteBuffers
#undef glDeleteBuffers
#endif
#define glDeleteBuffers glip_glDeleteBuffers

GLAPI void glip_glDeleteVertexArrays(GLsizei n, const GLuint * arrays);
#ifdef glDeleteVertexArrays
#undef glDeleteVertexArrays
#endif
#define glDeleteVertexArrays glip_glDeleteVertexArrays

GLAPI void glip_glDeleteTextures(GLsizei n, const GLuint * textures);
#ifdef glDeleteTextures
#undef glDeleteTextures
#endif
#define glDeleteTextures glip_glDeleteTextures

GLAPI void glip_glDeleteFramebuffers(GLsizei n, const GLuint * framebuffers);
#ifdef glDeleteFramebuffers
#undef glDeleteFramebuffers
#endif
#define glDeleteFramebuffers glip_glDeleteFramebuffers

GLAPI void glip_glReadBuffer(GLenum mode);
#ifdef glReadBuffer
#undef glReadBuffer
#endif
#define glReadBuffer glip_glReadBuffer

GLAPI void glip_glReadPixels(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLvoid * data);
#ifdef glReadPixels
#undef glReadPixels
#endif
#define glReadPixels glip_glReadPixels

enum glip_functions {
  _glip_glCreateShader=0,
  _glip_glShaderSource=1,
  _glip_glCompileShader=2,
  _glip_glGetShaderiv=3,
  _glip_glGetShaderInfoLog=4,
  _glip_glDeleteShader=5,
  _glip_glCreateProgram=6,
  _glip_glAttachShader=7,
  _glip_glBindFragDataLocation=8,
  _glip_glLinkProgram=9,
  _glip_glGetProgramiv=10,
  _glip_glGetProgramInfoLog=11,
  _glip_glDeleteProgram=12,
  _glip_glUseProgram=13,
  _glip_glGetIntegerv=14,
  _glip_glGenFramebuffers=15,
  _glip_glBindFramebuffer=16,
  _glip_glGenTextures=17,
  _glip_glTexImage2D=18,
  _glip_glTexParameteri=19,
  _glip_glFramebufferTexture=20,
  _glip_glBindTexture=21,
  _glip_glDrawBuffers=22,
  _glip_glGenBuffers=23,
  _glip_glBindBuffer=24,
  _glip_glBufferData=25,
  _glip_glGenVertexArrays=26,
  _glip_glBindVertexArray=27,
  _glip_glVertexAttribPointer=28,
  _glip_glCheckFramebufferStatus=29,
  _glip_glGetAttribLocation=30,
  _glip_glEnableVertexAttribArray=31,
  _glip_glEnable=32,
  _glip_glClear=33,
  _glip_glViewport=34,
  _glip_glGetUniformLocation=35,
  _glip_glUniform4fv=36,
  _glip_glDrawArrays=37,
  _glip_glGetError=38,
  _glip_glGetString=39,
  _glip_glGetStringi=40,
  _glip_glCullFace=41,
  _glip_glGenRenderbuffers=42,
  _glip_glBindRenderbuffer=43,
  _glip_glRenderbufferStorage=44,
  _glip_glFramebufferRenderbuffer=45,
  _glip_glVertexAttribDivisor=46,
  _glip_glDrawElementsInstanced=47,
  _glip_glDrawArraysInstanced=48,
  _glip_glDisable=49,
  _glip_glUniform1f=50,
  _glip_glUniform2f=51,
  _glip_glUniform3f=52,
  _glip_glUniform4f=53,
  _glip_glUniform1fv=54,
  _glip_glUniform2fv=55,
  _glip_glUniform3fv=56,
  _glip_glUniformMatrix2fv=57,
  _glip_glUniformMatrix3fv=58,
  _glip_glUniformMatrix4fv=59,
  _glip_glUniform1i=60,
  _glip_glUniform2i=61,
  _glip_glUniform3i=62,
  _glip_glUniform4i=63,
  _glip_glActiveTexture=64,
  _glip_glClearColor=65,
  _glip_glTexParameterf=66,
  _glip_glGenerateMipmap=67,
  _glip_glDeleteBuffers=68,
  _glip_glDeleteVertexArrays=69,
  _glip_glDeleteTextures=70,
  _glip_glDeleteFramebuffers=71,
  _glip_glReadBuffer=72,
  _glip_glReadPixels=73,
